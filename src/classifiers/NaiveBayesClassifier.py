...
def probabilityOfWordInSeveralDocumentsPutTogether(word, document_bag_dictionary):
    count = 0
    total = 0
...
responseFile = GENERATED_FILES_DIRECTORY+"naive_response"
...
for key, token_list in words_in_development.iteritems():
    ...
    for word in token_list:
        ...
        probability_word_positive_documents = probabilityOfWordInSeveralDocumentsPutTogether(word, positive_training_document_bag_dictionary)
        ...
        probability_word_negative_documents = probabilityOfWordInSeveralDocumentsPutTogether(word, negative_training_document_bag_dictionary)
        ...
        probability_word_objective_documents = probabilityOfWordInSeveralDocumentsPutTogether(word, objective_training_document_bag_dictionary)
