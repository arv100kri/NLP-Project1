...
@author: Arvind
Identify optimal tuning parameters from the training data
...
fileName = GENERATED_FILES_DIRECTORY+"tweaked_response_train_"+str(tuning_parameter)
f = open(fileName, "w")
...
subprocess.call([sys.executable, '../../scorer.py', '../../train.key', fileName])