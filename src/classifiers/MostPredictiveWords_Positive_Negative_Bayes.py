...
for key, token_list in words_in_development.iteritems():
    ...
    for word in token_list:
        ...
        if word not in words_difference_dictionary:
            words_difference_dictionary[word] = log_probability_positive - log_probability_negative
        else:
            difference = log_probability_positive - log_probability_negative
...
counter = 0
f = open(GENERATED_FILES_DIRECTORY+"top5pos_neg", "w")
